...
public class UserDto {
        @Schema(description = "Response returned of user object excluding password", name = "UserGetResponse")
        ...
        @Schema(description = "Request body to create new user", name = "UserCreateRequest")
        ...
        @Schema(description = "Request body to update user", name = "UserUpdateRequest")
        ...
        @Schema(description = "Request body to update user password", name = "UserPasswordUpdateRequest")
